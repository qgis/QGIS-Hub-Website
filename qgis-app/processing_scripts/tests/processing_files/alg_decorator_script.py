# Script template from QGIS Documentation:
# https://docs.qgis.org/3.40/en/docs/user_manual/processing/scripts.html#the-alg-decorator
...
@alg(
    name="bufferrasteralg",
    label="Buffer and export to raster (alg)",
...
@alg.input(type=alg.RASTER_LAYER_DEST, name="OUTPUT", label="Raster output")
...
@alg.output(
    type=alg.NUMBER, name="NUMBEROFFEATURES", label="Number of features processed"
)
