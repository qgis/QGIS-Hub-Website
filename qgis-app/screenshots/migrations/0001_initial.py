# Generated by Django 4.2.19 on 2025-07-11 06:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='A short name for the screenshot.', max_length=256, unique=True, verbose_name='Name')),
                ('description', models.TextField(help_text='Provide a concise description explaining what the screenshot demonstrates in QGIS, including relevant context or features highlighted.', max_length=5000, verbose_name='Description')),
                ('file', models.ImageField(help_text='An image file of the screenshot (static or animated GIF). The file size must be less than 10MB.', upload_to='screenshots/%Y', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'jpeg', 'gif', 'svg', 'webp', 'tiff', 'bmp'])], verbose_name='Screenshot Image File')),
                ('is_publishable', models.BooleanField(default=False, help_text='Is this screenshot eligible to be published on QGIS.org?', verbose_name='Is Publishable')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.ForeignKey(blank=True, help_text='The reviewed Screenshot.', null=True, on_delete=django.db.models.deletion.CASCADE, to='screenshots.screenshot', verbose_name='Screenshot')),
